...
static const _HumanArray_type_support_symbol_names_t _HumanArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_social_nav_interfaces, msg, HumanArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_social_nav_interfaces, msg, HumanArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_social_nav_interfaces, msg, HumanArray)() {
  return &::my_social_nav_interfaces::msg::rosidl_typesupport_c::HumanArray_message_type_support_handle;
}
